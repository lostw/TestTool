...
class NFXListCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        self.timeIntervalLabel.textColor = .white
        ...
        self.URLLabel.font = UIFont.NFXFont(size: 13)
    ...
    func configForObject(_ obj: NFXHTTPModel) {
        ...
        self.requestTimeLabel.text = obj.requestTime ?? "-"
        self.typeLabel.text = obj.responseType ?? "-"
    ...
    func isNewBasedOnDate(_ responseDate: Date) {
        self.circleView.isHidden = !responseDate.isGreaterThanDate(NFX.shared.getLastVisitDate())
    }
}
